  ...
  useEffect(() => {
    axios.get(`${API_URL}/api/admin/trainingDetails?type=${type}`)
      .then(response => {
        ...
        setVisible(response.data.training.link)
      })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (title === 'Select Title'
        ...
        navigate(`/attendance/${response.data._id}`);
      };
        ...
        <div className="bg-white mt-5 py-3 px-2">
          {
            ...
            <div className="h-80  flex justify-center items-center">
              <p className="text-xl border border-red-500 rounded-lg p-2">Registrations are now closed</p>
            </div>
